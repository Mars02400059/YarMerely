//
//  NSUserDefaults+Categories.m
//  BaseProject
//
//  Created by Eiwodetianna on 3/5/14.
//  Copyright (c) 2014 Eiwodetianna. All rights reserved.
//

#import "NSUserDefaults+Categories.h"

@implementation NSUserDefaults (Categories)
...
+ (void)setBool:(BOOL)value forKeys:(NSArray *)defaultNames {
    if (defaultNames != nil && [defaultNames count] != 0) {
        [defaultNames enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
            [self setBool:value forKey:obj];
        }];
    }
}
